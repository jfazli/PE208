...
public class PuissancePlaqueLabelRenderer extends WidgetRenderer {
	private static int LINE_SEPARATOR = '\n';
	private static int PADDING = 5;

	public Class getManagedType() {
		return PuissancePlaqueLabel.class;
	}
	...
	public void render(GraphicsContext g, Renderable renderable) {
		PuissancePlaqueLabel label = (PuissancePlaqueLabel) renderable;
