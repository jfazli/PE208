...
int64_t software_counter ;

// == MICROEJ_TRUE when the interrupt routine runs
uint8_t timer_interrupt_running;
...
void TIMER_IRQHandler(void)
{
	...
	timer_interrupt_running = MICROEJ_TRUE;
	{
	...
	timer_interrupt_running = MICROEJ_FALSE;
}
