...
/**
  ...
  *         Global Read Out Protection modification (level1 -> level0) 
  ...
  *          This parameter can be one of the following values:
  *            @arg OB_PcROPSelectionDisabled: nWRPi control the write protection of respective user sectors.
  *            @arg OB_PcROPSelectionEnabled: nWRPi control the  read&write protection (PCROP) of respective user sectors.
  * @retval None
  */
void FLASH_OB_PCROPSelectionConfig(uint8_t OB_PCROPSelect)
{  
  ...
  /* Check the parameters */
  assert_param(IS_OB_PCROP_SELECT(OB_PCROPSelect));
  
  /* Mask SPRMOD bit */
  optiontmp =  (uint8_t)((*(__IO uint8_t *)OPTCR_BYTE3_ADDRESS) & (uint8_t)0x7F); 
  /* Update Option Byte */
  *(__IO uint8_t *)OPTCR_BYTE3_ADDRESS = (uint8_t)(OB_PCROPSelect | optiontmp); 
