...
/** @defgroup  Selection_Protection_Mode
  * @{
  */
#define OB_PcROPSelectionDisabled   ((uint8_t)0x00) /*!< Disabled PcROP, nWPRi bits used for Write Protection on sector i */
#define OB_PcROPSelectionEnabled    ((uint8_t)0x80) /*!< Enable PcROP, nWPRi bits used for PCRoP Protection on sector i   */
#define IS_OB_PCROP_SELECT(PCROP) (((PCROP) == OB_PcROPSelectionDisabled) || ((PCROP) == OB_PcROPSelectionEnabled))
/**
  * @}
  */
