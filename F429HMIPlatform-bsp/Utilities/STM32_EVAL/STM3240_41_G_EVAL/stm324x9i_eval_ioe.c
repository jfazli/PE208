...
/** @defgroup STM324x9I_EVAL_IOE_Private_TypesDefinitions
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324x9I_EVAL_IOE_Private_Defines
  * @{
  */ 
...
/** @defgroup STM324x9I_EVAL_IOE_Private_Macros
  * @{
  */ 
/**
  * @}
...
/** @defgroup STM324x9I_EVAL_IOE_Private_Variables
  * @{
  */ 
...
/** @defgroup STM324x9I_EVAL_IOE_Private_FunctionPrototypes
  * @{
  */ 
...
/** @defgroup STM324x9I_EVAL_IOE_Private_Functions
  * @{
  */ 
#include "ioe.h"
...
uint8_t IOE_Config(void)
{
  ...
  IOE_Reset(); 
	...
	if(_IOE_FnctCmd(IOE_ADDR, IOE_TS_FCT | IOE_ADC_FCT, ENABLE)) return IOE_FAILURE ;
