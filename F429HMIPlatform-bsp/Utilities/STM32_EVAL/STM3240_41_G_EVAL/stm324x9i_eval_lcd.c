...
{ 
  ...
  LTDC_InitStruct.LTDC_HorizontalSync = 41;						//10 - 1
  ...
  LTDC_InitStruct.LTDC_AccumulatedActiveW = 522;			//480 + 43 - 1
  /* Configure accumulated active height */
  LTDC_InitStruct.LTDC_AccumulatedActiveH = 283;			//272 + 12 - 1
  /* Configure total width */
  LTDC_InitStruct.LTDC_TotalWidth = 524; 							//531 - 1
  /* Configure total height */
  LTDC_InitStruct.LTDC_TotalHeigh = 285;							//287 - 1
...
*/
 ...
 /* GPIOB configuration */
  ...
  GPIO_InitStruct.GPIO_Pin = GPIO_Pin_0 | GPIO_Pin_8 | GPIO_Pin_9 | GPIO_Pin_10 | \
                             GPIO_Pin_11 ;
